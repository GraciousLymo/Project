...
def calculates_results_stats(results_dic):
    ...
    results_starts_dic['pct_correct_dogs'] = 0
    ...
    results_stats_dic['pct_match'] =  results_stats_dic['pct_match']/100.0

     # Calculates % correct breed of dog
    results_stats_dic['pct_correct_breed'] =  results_stats_dic['pct_correct_breed']/100.0
   ...
   # Calculates % correct not-a-dog images
    if results_stats_dic['n_notdogs_img'] > 0:
        ...
        results_stats_dic['pct_correct_notdogs'] = results_stats_dic['pct_correct_notdogs']/100.0
