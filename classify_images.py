...
def  classify_images(images_dir, results_dic, model):
    ...
    filename = img_path
    classifer_labels = filename.lower()
    word_classifer_labels = classifier_labels.split("_")
    classifer_name = ""
    for word in word_classifier_labels:
        if word.isalpha():
            classifer_name += word + ""
    classifer_labels = classifer_labels.strip()

    filenames = images_dir
    pet_labels = filenames
    classifier_labels = img_path
